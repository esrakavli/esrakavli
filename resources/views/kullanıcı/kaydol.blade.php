                ...
                <div class="panel-body">
                   ...
                   @include('layouts.partials.errors')
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{route('kullanici.kaydol')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($errors->has('adsoyad'))
                                    <span class="help-block">
                                        <strong> {{$errors->first('ad-soyad')}}</strong>
                                    </span>
                                    @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="şifre-tekrari" class="col-md-4 control-label">Şifre (Tekrar)</label>
                            <div class="col-md-6">
                                <input id="şifre-tekrari" type="password" class="form-control" name="sifre_confirmation" required>
                            </div>
                        </div>
